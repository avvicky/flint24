...
const roboto = Roboto({
  subsets: ["latin"],
  weight: ["400", "700"], // Choose the weights you need (400 for normal, 700 for bold)
});
      ...
      <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
        <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
          <div className="flex items-center gap-1">
            <p className="text-lg md:text-xl mt-2 md:mt-1.5">By</p>
          </div>
          <h1
            className={`${roboto.className} text-2xl md:text-4xl font-bold relative`}
          >
            Mahendra College of Engineering
          </h1>
          <h1 className="text-lg md:text-4xl font-bold relative text-violet-700 dark:text-violet-600">
